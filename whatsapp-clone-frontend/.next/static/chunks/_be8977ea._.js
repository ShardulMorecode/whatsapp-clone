...
(()=>{
    const e = new Error("Cannot find module '../../components/ChatList'");
...
(()=>{
    const e = new Error("Cannot find module '../../components/MobileHeader'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
function WhatsAppPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WhatsAppPage.useEffect": ()=>{
            ...
            }["WhatsAppPage.useEffect"]).catch({
                "WhatsAppPage.useEffect": (e)=>{
                    console.error(e);
                }
            }["WhatsAppPage.useEffect"]);
        }
    ...
    }["WhatsAppPage.useWebsocket"], ("TURBOPACK compile-time value", "ws://localhost:8000/ws") || (("TURBOPACK compile-time truthy", 1) ? ("TURBOPACK compile-time value", "http://localhost:8000").replace(/^http/, "ws") + "/ws" : "TURBOPACK unreachable"));
