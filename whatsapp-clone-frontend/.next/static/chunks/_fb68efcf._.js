                ...
                children: [
                    ...
                    conversations.map((c)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: ()=>onSelect(wa),
                            className: "w-full text-left p-3 rounded-md transition flex items-start gap-3 ".concat(active === wa ? "bg-gray-800 border-l-4 border-blue-400" : "hover:bg-gray-800"),
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "font-medium ".concat(active === wa ? "text-white" : "text-gray-100"),
                                                    children: c.name || wa
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/ChatList.tsx",
                                                    lineNumber: 34,
...
async function postMessage(payload) {
    const res = await fetch("".concat(API_BASE, "/messages"), {
        method: "POST",
        headers: {
...
function ChatWindow(param) {
    let { wa_id, name, socketUpdater } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatWindow.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMessages"])(wa_id).then({
                "ChatWindow.useEffect": (msgs)=>{
                    setMessages(msgs);
                    scrollToBottom();
                }
            }["ChatWindow.useEffect"]).catch({
                "ChatWindow.useEffect": (e)=>{
                    console.error(e);
                    setMessages([]);
                }
            }["ChatWindow.useEffect"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatWindow.useEffect": ()=>{
            ...
            const handler = {
                "ChatWindow.useEffect.handler": (incoming)=>{
                    if (!incoming) return;
                    if (incoming.type === "new_message" || incoming.type === "outgoing") {
                        const m = incoming.message || incoming;
                        if (m.wa_id === wa_id) {
                            setMessages({
                                "ChatWindow.useEffect.handler": (prev)=>[
                                        ...prev,
                                        m
                                    ]
                            }["ChatWindow.useEffect.handler"]);
                            scrollToBottom();
                        }
                    }
                    if (incoming.type === "status_update" && incoming.meta_msg_id) {
                        setMessages({
                            "ChatWindow.useEffect.handler": (prev)=>prev.map({
                                    "ChatWindow.useEffect.handler": (pm)=>pm.message_id === incoming.meta_msg_id ? {
                                            ...pm,
    ...
    const handleSend = async (e)=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postMessage"])(payload);
            ...
            setMessages((prev)=>{
                ...
                return [
                    ...
                    {
                        ...payload,
                        message_id: ((_res_data = res.data) === null || _res_data === void 0 ? void 0 : _res_data._id) || ((_res_data1 = res.data) === null || _res_data1 === void 0 ? void 0 : _res_data1.id) || Date.now()
                    }
                ];
            });
            setText("");
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: messages.map((m, idx)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "max-w-[80%] ".concat(fromMe ? "ml-auto text-right" : ""),
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "".concat(fromMe ? "bg-blue-500 text-white" : "bg-gray-800 text-gray-100", " inline-block px-4 py-2 rounded-xl"),
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        " ",
                                        fromMe && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "ml-2",
                                            children: [
                                                "✓",
                                                m.status === "delivered" ? "✓" : "",
...
_s(ChatWindow, "v/uE1Gxdf8uusUSZzWxFFCuIFTQ=");
_c = ChatWindow;
var _c;
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FaBars, {}, void 0, false, {
...
//# sourceMappingURL=_fb68efcf._.js.map